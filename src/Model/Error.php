...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'message' => 'string',
        'outputRefIds' => 'string[]',
        'parameters' => '\Ansas\Ebay\Model\ErrorParameter[]',
        'subdomain' => 'string'
    ];
     ...
     * Gets parameters
     *
     * @return \Ansas\Ebay\Model\ErrorParameter[]|null
     */
     ...
     * Sets parameters
     *
     * @param \Ansas\Ebay\Model\ErrorParameter[]|null $parameters An array of name/value pairs that describe details the error condition. These are useful when multiple errors are returned.
     *
     * @return self
     */
