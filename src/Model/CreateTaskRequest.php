...
class CreateTaskRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets feedType
     *
     * @param string|null $feedType The feed type associated with the task. Only use a feedType that is available for your API. Available feed types: LMS FeedTypes: All LMS feed types except LMS_ORDER_REPORT and LMS_ACTIVE_INVENTORY_REPORT File Exchange FeedTypes
     *
     * @return self
     */
     ...
     * Sets schemaVersion
     *
     * @param string|null $schemaVersion The schemaVersion/version number of the file format (use the schema version of the API to which you are programming): LMS Version Details / Schema Version File Exchange Schema Version
     *
     * @return self
     */
