...
class SupportedConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets defaultValue
     *
     * @param string|null $defaultValue The default value for the property. If a value is omitted from the schedule and a default value is supplied, the default value is used.
     *
     * @return self
     */
