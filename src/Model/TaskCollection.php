...
class TaskCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets tasks
     *
     * @return \Ansas\Ebay\Model\Task[]|null
     */
     ...
     * Sets tasks
     *
     * @param \Ansas\Ebay\Model\Task[]|null $tasks An array of the tasks on this page. The tasks are sorted by creation date. An empty array is returned if the filter criteria excludes all tasks.
     *
     * @return self
     */
