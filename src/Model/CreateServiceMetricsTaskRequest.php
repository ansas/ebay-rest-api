...
class CreateServiceMetricsTaskRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets feedType
     *
     * @param string|null $feedType The feedType specified for the task. The report lists the transaction details that contribute to the service metrics evaluation. Supported types include: CUSTOMER_SERVICE_METRICS_REPORT
     *
     * @return self
     */
     ...
     * Sets schemaVersion
     *
     * @param string|null $schemaVersion The version number of the file format. Valid value: 1.0
     *
     * @return self
     */
