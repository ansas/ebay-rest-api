...
class InventoryTaskCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets tasks
     *
     * @param \Ansas\Ebay\Model\InventoryTask[]|null $tasks An array of the inventory tasks on this page. The tasks are sorted by creation date. Note: An empty array is returned if the filter criteria excludes all tasks.
     *
     * @return self
     */
