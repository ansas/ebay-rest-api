...
class InventoryTaskCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'tasks' => '\Ansas\Ebay\Model\InventoryTask[]',
        'total' => 'int'
    ];
     ...
     * Gets tasks
     *
     * @return \Ansas\Ebay\Model\InventoryTask[]|null
     */
     ...
     * Sets tasks
     *
     * @param \Ansas\Ebay\Model\InventoryTask[]|null $tasks An array of the inventory tasks on this page. The tasks are sorted by creation date.<br /><br /><span class=\"tablenote\"><strong>Note:</strong> An empty array is returned if the filter criteria excludes all tasks.</span>
     *
     * @return self
     */
