...
class OrderFilterCriteria implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets orderStatus
     *
     * @param string|null $orderStatus The order status of the orders returned. If the filter is omitted from createOrderTask call, orders that are in both ACTIVE and COMPLETED states are returned. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/feed/types/api:OrderStatusEnum'>eBay API documentation</a>
     *
     * @return self
     */
