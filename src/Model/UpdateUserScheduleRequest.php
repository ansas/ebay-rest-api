...
class UpdateUserScheduleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets schemaVersion
     *
     * @param string|null $schemaVersion The schema version of the feedType for the schedule. This field is required if the feedType has a schema version. This field is available as specified by the template (scheduleTemplateId). The template can specify this field as optional or required, and optionally provides a default value.
     *
     * @return self
     */
