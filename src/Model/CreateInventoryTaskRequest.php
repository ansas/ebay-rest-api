...
class CreateInventoryTaskRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets feedType
     *
     * @param string|null $feedType The feed type associated with the inventory task you are about to create. Use a feedType that is available for your API. Presently, only one feed type is available: LMS_ACTIVE_INVENTORY_REPORT
     *
     * @return self
     */
