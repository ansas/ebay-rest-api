...
class CustomerServiceMetricsFilterCriteria implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $customerServiceMetricType An enumeration value that specifies the customer service metric that eBay tracks to measure seller performance. See CustomerServiceMetricTypeEnum for values. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/feed/types/api:CustomerServiceMetricTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     *
     * @param string|null $evaluationMarketplaceId An enumeration value that specifies the eBay marketplace where the evaluation occurs. See MarketplaceIdEnum for values. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/feed/types/bas:MarketplaceIdEnum'>eBay API documentation</a>
     *
     * @return self
     */
