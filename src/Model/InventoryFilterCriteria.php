...
class InventoryFilterCriteria implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets listingFormat
     *
     * @param string|null $listingFormat The type of buying option for the order. Supports LMS_ACTIVE_INVENTORY_REPORT. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/feed/types/api:ListingFormatEnum'>eBay API documentation</a>
     *
     * @return self
     */
