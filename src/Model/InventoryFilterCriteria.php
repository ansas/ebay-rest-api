...
class InventoryFilterCriteria implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'listingFormat' => 'setListingFormat',
    ...
    protected static $getters = [
        ...
        'listingFormat' => 'getListingFormat',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['listingFormat'] = $data['listingFormat'] ?? null;
    ...
    {
        return $this->container['listingFormat'];
    }

    /**
     * Sets listingFormat
     *
     * @param string|null $listingFormat The type of buying option for the order. Supports <code>LMS_ACTIVE_INVENTORY_REPORT</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/feed/types/api:ListingFormatEnum'>eBay API documentation</a>
     *
     * @return self
     */
    public function setListingFormat($listingFormat)
    {
        $this->container['listingFormat'] = $listingFormat;
