...
class Task implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets detailHref
     *
     * @param string|null $detailHref The path to the call URI used to retrieve the task. This field points to the GetOrderTask URI if the task is for LMS_ORDER_REPORT or will be null if this task is for LMS_ORDER_ACK.
     *
     * @return self
     */
