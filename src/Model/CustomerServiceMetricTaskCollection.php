...
class CustomerServiceMetricTaskCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'tasks' => '\Ansas\Ebay\Model\ServiceMetricsTask[]',
        'total' => 'int'
    ];
     ...
     * Sets offset
     *
     * @param int|null $offset The number of results skipped in the result set before returning the first result. This value can be set in the request with the <b>offset</b> query parameter. <p class=\"tablenote\"><strong>Note: </strong>The items in a paginated result set use a zero-based list where the first item in the list has an offset of <code>0</code>.</p>
     *
     * @return self
     */
     ...
     * Gets tasks
     *
     * @return \Ansas\Ebay\Model\ServiceMetricsTask[]|null
     */
     ...
     * Sets tasks
     *
     * @param \Ansas\Ebay\Model\ServiceMetricsTask[]|null $tasks An array of the customer service tasks on this page. The tasks are sorted by creation date. An empty array is returned if the filter criteria excludes all tasks.
     *
     * @return self
     */
