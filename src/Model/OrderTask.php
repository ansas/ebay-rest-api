...
class OrderTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets detailHref
     *
     * @param string|null $detailHref The path to the call URI used to retrieve the task.
     *
     * @return self
     */
     ...
     * Sets schemaVersion
     *
     * @param string|null $schemaVersion The schema version number associated with the create task.
     *
     * @return self
     */
