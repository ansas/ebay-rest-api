...
class OrderTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets completionDate
     *
     * @param string|null $completionDate The timestamp when the task went into the COMPLETED or COMPLETED_WITH_ERROR state. This state means that eBay has compiled the report for the seller based on the seller&rsquo;s filter criteria, and the seller can run a getResultFile call to download the report.
     *
     * @return self
     */
