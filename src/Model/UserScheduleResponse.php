...
class UserScheduleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets scheduleId
     *
     * @param string|null $scheduleId The ID of the schedule. This ID is generated when the schedule was created by the <strong>createSchedule</strong> method.
     *
     * @return self
     */
     ...
     * Sets feedType
     *
     * @param string|null $feedType The <strong>feedType</strong> associated with the schedule.
     *
     * @return self
     */
     ...
     *
     * @param int|null $preferredTriggerDayOfMonth The preferred day of the month to trigger the schedule. This field can be used with <strong>preferredTriggerHour</strong> for monthly schedules. The last day of the month is used for numbers larger than the number of days in the month.
     *
     * @return self
     */
     ...
     *
     * @param string|null $preferredTriggerHour The preferred two-digit hour of the day to trigger the schedule. <br /><br /><b>Format:</b> UTC <code>hhZ</code><br /><br />For example, the following represents 11:00 am UTC:<br /><br /><code>11Z</code><br /><br />
     *
     * @return self
     */
     ...
     *
     * @param string|null $scheduleEndDate The timestamp on which the report generation (subscription) ends. After this date, the schedule status becomes <code>INACTIVE</code>.
     *
     * @return self
     */
