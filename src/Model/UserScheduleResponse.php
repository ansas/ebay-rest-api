...
class UserScheduleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['scheduleId'] = $data['scheduleId'] ?? null;
        $this->container['creationDate'] = $data['creationDate'] ?? null;
        $this->container['feedType'] = $data['feedType'] ?? null;
        $this->container['lastModifiedDate'] = $data['lastModifiedDate'] ?? null;
        ...
        $this->container['statusReason'] = $data['statusReason'] ?? null;
    }
     ...
     * Sets scheduleId
     *
     * @param string|null $scheduleId The ID of the schedule. This ID is generated when the schedule was created by the createSchedule method.
     *
     * @return self
     */
     ...
     * Sets creationDate
     *
     * @param string|null $creationDate The creation date of the schedule in hours based on the 24-hour Coordinated Universal Time (UTC) clock.
     *
     * @return self
     */
     ...
     * Sets feedType
     *
     * @param string|null $feedType The feedType associated with the schedule.
     *
     * @return self
     */
     ...
     *
     * @param string|null $lastModifiedDate The date the schedule was last modified.
     *
     * @return self
     */
     ...
     *
     * @param int|null $preferredTriggerDayOfMonth The preferred day of the month to trigger the schedule. This field can be used with preferredTriggerHour for monthly schedules. The last day of the month is used for numbers larger than the number of days in the month.
     *
     * @return self
     */
     ...
     *
     * @param string|null $preferredTriggerDayOfWeek The preferred day of the week to trigger the schedule. This field can be used with preferredTriggerHour for weekly schedules. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/feed/types/api:DayOfWeekEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     *
     * @param string|null $preferredTriggerHour The preferred two-digit hour of the day to trigger the schedule. Format: UTC hhZ For example, the following represents 11:00 am UTC: 11Z
     *
     * @return self
     */
     ...
     *
     * @param string|null $scheduleEndDate The timestamp on which the report generation (subscription) ends. After this date, the schedule status becomes INACTIVE.
     *
     * @return self
     */
     ...
     * Sets scheduleName
     *
     * @param string|null $scheduleName The schedule name assigned by the user for the created schedule. Users assign this name for their reference.
     *
     * @return self
     */
     ...
     *
     * @param string|null $scheduleStartDate The timestamp that indicates the start of the report generation.
     *
     * @return self
     */
     ...
     *
     * @param string|null $scheduleTemplateId The ID of the template used to create this schedule.
     *
     * @return self
     */
     ...
     * Sets schemaVersion
     *
     * @param string|null $schemaVersion The schema version of the feedType for the schedule.
     *
     * @return self
     */
     ...
     * Sets statusReason
     *
     * @param string|null $statusReason The reason the schedule is inactive. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/feed/types/api:StatusReasonEnum'>eBay API documentation</a>
     *
     * @return self
     */
