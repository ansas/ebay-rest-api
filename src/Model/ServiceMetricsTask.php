...
class ServiceMetricsTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets completionDate
     *
     * @param string|null $completionDate The timestamp when the customer service metrics task went into the COMPLETED or COMPLETED_WITH_ERROR state. This field is only returned if the status is one of the two completed values. This state means that eBay has compiled the report for the seller based on the seller&rsquo;s filter criteria, and the seller can run a getResultFile call to download the report.
     *
     * @return self
     */
     ...
     * Sets detailHref
     *
     * @param string|null $detailHref The relative getCustomerServiceMetricTask call URI path to retrieve the corresponding task.
     *
     * @return self
     */
     ...
     * Sets schemaVersion
     *
     * @param string|null $schemaVersion The schema version number of the file format. If omitted, the default value is used. Default value: 1.0
     *
     * @return self
     */
