...
class InventoryTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets taskId
     *
     * @param string|null $taskId The ID of the task. This ID is generated when the task was created by the createInventoryTask method.
     *
     * @return self
     */
     ...
     * Sets completionDate
     *
     * @param string|null $completionDate The timestamp when the task status went into the COMPLETED, COMPLETED_WITH_ERROR, or PARTIALLY_PROCESSED state. This field is only returned if the status is one of the three completed values.
     *
     * @return self
     */
     ...
     * Sets detailHref
     *
     * @param string|null $detailHref The path to the call URI used to retrieve the task. This field points to the getInventoryTask URI.
     *
     * @return self
     */
     ...
     *
     * @param string|null $inventoryFileTemplate The inventory file template used to return specific types of inventory tasks, if set in the createInventoryTask method. This field does not apply to LMS_ACTIVE_INVENTORY_REPORT feed types. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/feed/types/api:InventoryFileTemplateEnum'>eBay API documentation</a>
     *
     * @return self
     */
